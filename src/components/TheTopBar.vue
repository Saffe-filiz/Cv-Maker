<template>
	<div class="hidden xl:flex w-full h-[70px] bg-white px-6 justify-between items-center border-b border-borderColor">
		<div class="w-auto h-[47px]  flex items-center">
		...
		<div class="w-[653px] h-[47px] flex justify-between">
			<div class="w-[134px] h-full rounded flex items-center border border-borderColor ">
			...
			<div class="w-[140px] h-full bg-white rounded border border-borderColor flex justify-center items-center">
			...
			<button class="w-[108px] h-full rounded bg-[#4372ff] flex items-center justify-center disabled:bg-borderColor">
			...
			<button class="w-[214px] h-full rounded bg-[#50af81] flex items-center justify-center">
			    <span class="w-6 h-6 mr-2.5">
				    <img class="w-full h-full" src="../assets/dowlandCv.svg">
			    </span>
			    <span class="text-white">DOWNLOAD MY CV</span>
		   </button>
		</div>
	</div>
</template>
