		...
		<div class="w-full max-h-[80vh] flex flex-col" ref="parent">
			...
			<div class="w-full h-auto overflow-y-auto overflow-x-hidden sideNav" ref="sideList">
			    <ul class="w-full  flex flex-col items-center gap-y-[5px]" ref="list">
					...
					<span class="group-hover:text-[#4372FF] text-center" :class="[currentSection == 1 ? 'text-black': 'text-white']">Summary</span>
				    </li>
				    <li class="sideBarList group" :class="{'bg-[#e7ecf9]': currentSection == 2}" @click="goToSection(2)">
					<span >
					...
					<span class="group-hover:text-[#4372FF] text-center" :class="[currentSection == 2 ? 'text-black': 'text-white']">Experiences</span>
				    </li>
				    <li class="sideBarList group" :class="{'bg-[#e7ecf9]': currentSection == 3}" @click="goToSection(3)">
					<span>
					...
					<span class="group-hover:text-[#4372FF] text-center" :class="[currentSection == 3 ? 'text-black': 'text-white']">Education</span>
				    </li>
				    <li class="sideBarList group" :class="{'bg-[#e7ecf9]': currentSection == 4}" @click="goToSection(4)">
					<span >
					...
					<span class="group-hover:text-[#4372FF] text-center" :class="[currentSection == 4 ? 'text-black': 'text-white']">Skills</span>
				    </li>
				    <li class="sideBarList group" :class="{'bg-[#e7ecf9]': currentSection == 5}" @click="goToSection(5)">
					<span >
					...
					<span class="group-hover:text-[#4372FF] text-center" :class="[currentSection == 5 ? 'text-black': 'text-white']">Languages</span>
				    </li>
				    <li class="sideBarList group" :class="{'bg-[#e7ecf9]': currentSection == 6}" ref="itemTwo" @click="goToSection(6)">
					<span >
					...
					<span class="group-hover:text-[#4372FF] text-center" :class="[currentSection == 6 ? 'text-black': 'text-white']">Interests</span>
				    </li>
		        </ul>
			</div> 
